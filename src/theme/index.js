export default {
  ...
  colors: {
    ...
    heading_secondary: "#1ec2ba", // heading color
    background: "#111111", // body background color
    background_secondary: "#F9FBFD", // secondary background color
    border_color: "#E5ECF4", // border color
    yellow: "#FFA740", // border color
    primary: "#1ec2ba", // primary button and link color
    secondary: "#1ec2ba", // secondary color - can be used for hover states
  ...
  buttons: {
    ...
    primary: {
      ...
      bg: "primary",
      "&:hover": {
        boxShadow: "rgba(204, 251, 255, 0.897) 0px 9px 20px -5px",
      },
    },
    whiteButton: {
      variant: "buttons.defaultBtn",
